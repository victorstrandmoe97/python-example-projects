# Sandbox Inspection Report (Sun-09-Nov-2025-2149UTC-004)

**Time:** 2025-11-09 21:55:41 UTC
...
### STDOUT
{
  ...
  "findings": [
    {
      ...
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/complete_run_audit.py",
      "line": 90,
    ...
    },
    {
      ...
      "severity": "medium",
      "description": "Python performs outbound network requests via requests library",
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/main.py",
      "line": 39,
      "excerpt": "response = requests.post(url, headers=headers, json=payload)"
    },
    {
      ...
      "severity": "medium",
      "description": "Python performs outbound network requests via requests library",
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/upload_blob_storage.py",
      "line": 25,
    ...
    },
    {
      ...
      "severity": "medium",
      "description": "Python performs outbound network requests via requests library",
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/start_run_audit.py",
      "line": 48,
    ...
    },
    {
      ...
      "severity": "medium",
      "description": "Python performs outbound network requests via requests library",
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/update_run_audit.py",
      "line": 45,
    ...
    },
    {
      ...
      "severity": "medium",
      "description": "Python performs outbound network requests via requests library",
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/initialise_run.py",
      "line": 28,
      "excerpt": "resp = requests.post("
    },
    {
      ...
      "file": "/tmp/mcp_semgrep_k0iwqf72/repo/sast/python/project/badpython.py",
      "line": 9,
  ...
  "tools": [
    {
      "command": "semgrep --config p/ci /tmp/mcp_semgrep_k0iwqf72/repo",
      "returncode": "0",
